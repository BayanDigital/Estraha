...
class _RoomDetailsScreenState extends State<RoomDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion(
      ...
      child: GetBuilder<RoomDetailsController>(builder: (controller) {
        return Scaffold(
            backgroundColor: Theme.of(context).scaffoldBackgroundColor,
            body: controller.roomList.isEmpty
                ? const CustomLoader()
                : Stack(
                    children: [
                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: controller
                                      .roomList[widget.index].images?.length ??
                                  0,
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                      ...
                                      child: CustomCashNetworkImage(
                                        imageUrl:
                                            '${UrlContainer.domainUrl}/${controller.hotelDetailsScreenController.roomTypeImagePath}/${controller.roomList[widget.index].images?[index].image}',
                                      )),
                                );
                              },
                                  ...
                                  MarqueeWidget(
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '  ${controller.roomSelectController.getBedInfo(widget.index).tr}',
                                          style: regularDefault.copyWith(
                                              color: MyColor.thinTextColor),
                                        ),
                                        ...
                                        Text(
                                          '  ${controller.roomList[widget.index].totalAdult.toString().tr} ${MyStrings.adults.tr}',
                                          style: regularDefault.copyWith(
                                              color: MyColor.thinTextColor),
                                        ),
                                        Text(
                                          ' ${controller.roomList[widget.index].totalChild.toString().tr} ${MyStrings.children.tr}',
                                          style: regularDefault.copyWith(
                                              color: MyColor.thinTextColor),
                                        ),
                                      ],
                          ...
                          Positioned(
                            ...
                            child: Center(
                              child: Row(
                                ...
                                controller.roomList[widget.index].images
                                        ?.length ??
                                    0,
                                (index) => Container(
                                  width: 7,
                                  ...
                                  decoration: BoxDecoration(
                                      color: controller.roomList[widget.index]
                                                  .images!.length <
                                              2
