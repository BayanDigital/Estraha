                  ...
                  child: MarqueeWidget(
                    ...
                    child: Row(
                      children: [
                        ...
                        const DotWidget(),
                        Text(
                          '${homeController.numberOfRooms.toString().tr} ${MyStrings.room.tr}',
                          style: mediumDefault.copyWith(
                              fontFamily: "Tajawal",
                              color: Theme.of(context).primaryColor),
                        ),
                        const DotWidget(),
                        Text(
                          '${homeController.numberOfGuests.toString().tr} ${MyStrings.guests.tr}',
                          style: mediumDefault.copyWith(
                              fontFamily: "Tajawal",
                              color: Theme.of(context).primaryColor),
                        ),
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text: DateConverter.convertTimeToTime(
                            controller.hotelSetting?.checkinTime ?? '00:00:00'),
                ...
                RichText(
                  text: TextSpan(
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text: DateConverter.convertTimeToTime(
                            controller.hotelSetting?.checkoutTime ??
                                '00:00:00'),
                        style: boldLarge.copyWith(
                            fontFamily: "Tajawal",
                            color: Theme.of(context).primaryColor),
