        ...
        return Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children:
                    List.generate(controller.roomTypesList.length, (index) {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              controller.roomTypesList[index].name
                                  .toString()
                                  .tr,
                              style: mediumLarge),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                controller.roomTypesList[index].beds?.length
                                        .toString()
                                        .tr ??
                                    '',
                              ...
                              const SizedBox(width: Dimensions.space8),
                              Text(
                                  '${controller.roomTypesList[index].totalAdult.toString().tr} ${MyStrings.adults.tr}, ${controller.roomTypesList[index].totalChild} ${MyStrings.children}',
                                  style: regularDefault.copyWith(
                                      color: MyColor.titleTextColor))
                            ],
                          ),
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                        text:
                                            " \$${Converter.formatNumber(controller.roomTypesList[index].fare.toString())}",
                                        style: regularDefault.copyWith(
