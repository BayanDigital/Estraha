...
class _HotelDetailsScreenState extends State<HotelDetailsScreen> {
  ...
  void initState() {
    ...
    final controller =
        Get.put(HotelDetailsScreenController(hotelDetailsRepo: Get.find()));
                        ...
                        child: Stack(children: [
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount:
                                  controller.hotel?.coverPhotos?.length ?? 1,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    List<String> imageList = [];
                                    controller.hotel?.coverPhotos
                                        ?.forEach((element) {
                                      imageList
                                          .add(element.coverPhotoUrl ?? '');
                                    });

                                    if (imageList.isEmpty) return;

                                    Get.toNamed(RouteHelper.photoViewScreen,
                                                      ...
                                                      Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                ...
                                                                vertical: 3.0),
                                                        child: Text(
                                                          "${controller.hotelSetting?.starRating.toString().tr} ${MyStrings.starHotel.tr}",
                                                          style: boldOverLarge.copyWith(
                                                              fontFamily:
                                                                  "Tajawal",
                                                              fontSize: 14,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  //       ),
                                  //       Text(
                                  //         controller.hotelSetting?.address
                                  //                 .toString()
                                  //                 .tr ??
                                  //             '',
                                  //         style: regularDefault.copyWith(
                                  ...
                                  //       Text(
                                  //         "${controller.hotelSetting?.starRating} ${MyStrings.starHotel.tr}",
                                  //         style: boldOverLarge.copyWith(
                                  //             fontFamily: "Tajawal",
                                  //             fontSize: 14,
                                  //             color: Theme.of(context)
                                          ...
                                          GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                      '+${controller.hotelAmenitiesList.length}',
                                                      style: boldSmall.copyWith(
                                                          color: MyColor
                                                              .primaryColor)),
                                                  Text(MyStrings.more.tr,
                                                      style: boldSmall.copyWith(
                                                          color: MyColor
                                                              .primaryColor)),
                                                ],
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      CustomReadMoreText(
                                        '${controller.hotelSetting?.description?.tr ?? ''} ',
                                        trimLines: 4,
                                        colorClickableText:
                                            MyColor.primaryColor,
                          ...
                          Align(
                            alignment: Alignment.center,
                            child: controller.modifiedFromDetails == true &&
                          ...
                          Positioned(
                            ...
                            child: Center(
                              child: Row(
                                  children: List.generate(
                                      controller.hotel?.coverPhotos?.length ??
                                          0,
                                      (index) => Container(
                                            width: 7,
                                            height: 7,
            ...
            floatingActionButton: controller.isLoading
                ...
                : Container(
                    ...
                    child: RoundedButton(
                        ...
                        color: controller.isRoomAvailable
                            ? MyColor.primaryColor
                            : MyColor.primaryColor.withOpacity(.5),
                        textColor: controller.isRoomAvailable
                            ? MyColor.colorWhite
                            : MyColor.colorWhite.withOpacity(.5),
                        press: () {
                          if (controller.homeController.checkOutDate ==
                            ...
                            CustomSnackBar.error(
                                errorList: [MyStrings.roomNotAvailable.tr]);
                          }
                        }),
                  ),
          ),
