...
import 'package:booking_box/view/screens/bottom_nav_sections/home/widget/quantity_button.dart';
                ...
                Row(
                  ...
                  children: [
                    Text(
                      MyStrings.adults.tr,
                      style:
                          regularLarge.copyWith(color: MyColor.bodyTextColor),
                    ),
                    Row(
                      children: [
                        QuantityButton(
                        ...
                        Text(
                          controller.roomList[index].adults.toString().tr,
                          style: regularLarge,
                        ),
                        const SizedBox(
                          width: Dimensions.space32,
                    ...
                    Row(
                      children: [
                        QuantityButton(
                          ...
                          icon: Icons.remove,
                          press: () =>
                              controller.decreaseQuantityChildren(index),
                        ),
                        const SizedBox(
                          width: Dimensions.space32,
                        ),
                        Text(
                          controller.roomList[index].children.toString().tr,
                          style: regularLarge,
                        ),
                        const SizedBox(
                          width: Dimensions.space32,
                        ...
                        QuantityButton(
                          press: () =>
                              controller.increaseQuantityChildren(index),
                          controller: controller,
                          icon: Icons.add,
                          bgColor: MyColor.primaryColor,
                          iconColor: MyColor.colorBlack,
