...
import 'package:booking_box/view/screens/bottom_nav_sections/my_booking/canceled_history/widgets/custom_no_canceled_history.dart';
...
class CanceledHistoryScreen extends StatefulWidget
    implements PreferredSizeWidget {
  final bool isShowAppBar;

  const CanceledHistoryScreen({super.key, this.isShowAppBar = false});

  @override
  State<CanceledHistoryScreen> createState() => _BookingHistoryScreenState();

  @override
  Size get preferredSize => throw UnimplementedError();
}

class _BookingHistoryScreenState extends State<CanceledHistoryScreen> {
          ...
          body: controller.isLoading
              ...
              : controller.bookingHistoryList.isEmpty
                  ? Padding(
                      ...
                      child: CustomNoCanceledHistory(
                        title: MyStrings.noCanceledTrips,
                        subtitle:
                            "Review your canceled flights, you may want to rebook them."
                                .tr,
                      ),
                    )
                  : ListView.builder(
