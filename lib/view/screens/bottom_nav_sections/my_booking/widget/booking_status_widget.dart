...
class HistoryStatusWidget extends StatelessWidget {
  ...
  const HistoryStatusWidget({Key? key, required this.status}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(
          vertical: Dimensions.space7, horizontal: Dimensions.space10),
          ...
          color: status == MyStrings.upcoming
              ...
              : status == MyStrings.running
                  ...
                  : status == MyStrings.canceled
                      ? MyColor.colorRed.withOpacity(.9)
      ...
      child: Text(
        ...
        style: boldSmall.copyWith(color: MyColor.colorWhite),
      ),
    );
  }
}
