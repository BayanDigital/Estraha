...
import 'package:booking_box/data/model/language/main_language_response_model.dart';
import 'package:booking_box/view/screens/bottom_nav_sections/menu/widget/language_dialog_body.dart';

void showLanguageDialog(
    String languageList, Locale selectedLocal, BuildContext context,
    {bool fromSplash = false}) {
  MainLanguageResponseModel model =
      MainLanguageResponseModel.fromJson(jsonDecode(languageList));
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: LanguageDialogBody(
              ...
              currentLangCode: selectedLocal.languageCode),
        );
      });
}
