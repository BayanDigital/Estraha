...
import '../../bottom_nav_sections/home/widget/add_room_section.dart';
              ...
              Stack(
                children: [
                  ...
                  GestureDetector(
                    onTap: onBackPress,
                    child: Align(
                      alignment: MyUtils.isRtl(context)
                          ? Alignment.centerRight
                          : Alignment.centerLeft,
                      child: Container(
                          color: Theme.of(context).scaffoldBackgroundColor,
                          padding: const EdgeInsetsDirectional.only(
                              start: 6, end: 20, top: 6, bottom: 10),
                          child: Icon(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        await showCustomDateRangePicker(
                          ...
                          initialDateRange: controller.checkOutDate ==
                              ...
                              : DateTimeRange(
                                  start: controller
                                      .dateTimeFormat(controller.checkInDate),
                                  end: controller
                                      .dateTimeFormat(controller.checkOutDate)),
                        );
                      },
                      child: Container(
                        color: Theme.of(context).scaffoldBackgroundColor,
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(MyImages.calender,
                                    width: 12,
                                    height: 12,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(controller.checkOutDate.tr,
                                style: semiBoldLarge.copyWith(
                                    color: Theme.of(context).primaryColor,
                                    fontSize: 15)),
                            const SizedBox(height: 4),
                ...
                onTap: () {
                  ...
                  CustomBottomSheet(
                      ...
                      child: GetBuilder<HomeController>(
                        builder: (controller) =>
                            AddRoomsSection(controller: controller),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(MyImages.person,
                                    width: 12,
                                    height: 12,
                                    colorFilter: ColorFilter.mode(
                                        Theme.of(context).primaryColor,
                            ...
                            const SizedBox(height: 4),
                            Text(
                              "${controller.numberOfGuests.toString().tr} ${MyStrings.guests.tr}",
                              style: semiBoldLarge.copyWith(
                                  color: Theme.of(context).primaryColor,
                                  fontFamily: "Tajawal",
                                  fontSize: 15),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(
                                  MyStrings.rooms.toUpperCase().tr,
                                  style: regularDefault.copyWith(
                                      color: Theme.of(context).primaryColor,
                                      fontFamily: "Tajawal",
                                      fontSize: 12),
                            ...
                            const SizedBox(height: 4),
                            Text(
                                '${controller.numberOfRooms} ${MyStrings.rooms.tr}',
                                style: semiBoldLarge.copyWith(
                                    color: Theme.of(context).primaryColor,
                                    fontFamily: "Tajawal",
                                    fontSize: 15)),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.symmetric(
                    vertical: MediaQuery.of(context).size.height * .021,
                  ),
                  decoration: BoxDecoration(
                      color: MyColor.primaryColor,
                      borderRadius: BorderRadius.circular(6)),
                  child: Text(
                    MyStrings.modifySearch.tr,
                    style: boldLarge.copyWith(
                        fontFamily: "Tajawal",
