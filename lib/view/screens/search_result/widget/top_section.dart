...
class TopSectionSearchResult extends StatelessWidget {
  ...
  const TopSectionSearchResult(
      {super.key,
      required this.isFromDestination,
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          homeController.searchedPlaceName.tr,
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '${searchResultController.formatDateInDayMonth(homeController.checkInDate).tr} ${MyStrings.to.tr} ${searchResultController.formatDateInDayMonth(homeController.checkOutDate).tr}',
                              style: tajawal14White400.copyWith(
                                color: Theme.of(context).primaryColor,
                                fontSize: 12,
                              ),
                            ...
                            Text(
                              '  ${homeController.numberOfRooms} ${MyStrings.rooms.tr}',
                              style: tajawal14White400.copyWith(
                                color: Theme.of(context).primaryColor,
                                fontSize: 12,
                              ),
                            ...
                            Text(
                              '  ${homeController.numberOfGuests} ${MyStrings.guests.tr}',
                              style: tajawal14White400.copyWith(
                                color: Theme.of(context).primaryColor,
                                fontSize: 12,
                              ),
                  ...
                  Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          homeController.updateSearchData(
                              setPresentDataIntoPrevious: true);
                          homeController.previousRoomList =
                              List.from(homeController.roomList);
                          homeController.previousSearchPlaceName =
                              homeController.searchedPlaceName;

                          CustomBottomSheet(
                              child: PopScope(
                            onPopInvoked: (didPop) {
                              if (searchResultController.isClickModifySearch ==
                                  false) {
                                homeController.roomList =
                                    List.from(homeController.previousRoomList);
                            ...
                            child: ModifySearchSection(
                              ...
                              onTap: () {
                                if (homeController.checkOutDate ==
                                    MyStrings.checkOutDate) {
                                  CustomSnackBar.error(
                                      errorList: [MyStrings.selectCheckOut.tr]);
                                } else {
                                  searchResultController.isClickModifySearch =
                                      true;
                                  Get.back();
                                  searchResultController.isClickModifySearch =
                                      false;
                              ...
                              onBackPress: () {
                                if (searchResultController
                                        .isClickModifySearch ==
                                    false) {
                                  homeController.roomList = List.from(
                                      homeController.previousRoomList);
                                  homeController.countTotalGuest();
                                  homeController.updateSearchData(
                                      setPreviousDataIntoPresent: true);
