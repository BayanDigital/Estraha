...
class SearchResultScreen extends StatefulWidget {
  ...
  const SearchResultScreen({Key? key, this.isFromDestination = false})
      : super(key: key);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      searchResultController.loadData(
          isFromDestination: widget.isFromDestination);
                            ...
                            : SafeArea(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    if (controller.searchResultList.length ==
                                        index) {
                                    ...
                                    return GestureDetector(
                                      onTap: () {
                                        controller
                                            .setHotelAndOwnerId(hotelResult);
                                        Get.toNamed(
                                            RouteHelper.hotelDetailsScreen,
                                            arguments:
                                                hotelResult.ownerId.toString());
                                      },
                                      child: Container(
                                        margin:
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                ClipRRect(
                                                    ...
                                                    child:
                                                      ...
                                                      imageUrl:
                                                          "${controller.logoPath}/${hotelResult.logo}",
                                                      imageHeight:
                                                          size.height * .19,
                                            ...
                                            Row(
                                              children: [
                                                Text(
                                                  "${hotelResult.starRating.toString().tr} ${MyStrings.starHotel.tr}",
                                                  style:
                                                      regularDefault.copyWith(
                                                          color:
                                                              Theme.of(context)
                                                  ...
                                                  child: RichText(
                                                    text: TextSpan(
                                                      ...
                                                      children: <TextSpan>[
                                                        ...
                                                        TextSpan(
                                                          text:
                                                              " ${controller.searchRepo.apiClient.getCurrencyOrUsername(isSymbol: true)}${Converter.formatNumber(controller.searchResultList[index].minimumFare ?? '0', precision: 0)}",
              ...
              : GestureDetector(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(
                        horizontal: 24, vertical: size.height * .011),
                    decoration: BoxDecoration(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          MyStrings.filter.tr,
                          style:
                              mediumLarge.copyWith(color: MyColor.colorWhite),
                        )
                      ],
                    ),
                  ),
