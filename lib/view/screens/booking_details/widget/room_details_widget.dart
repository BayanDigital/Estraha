...
class RoomDetailsWidget extends StatelessWidget {
  ...
  const RoomDetailsWidget({super.key, required this.controller});
          ...
          children: List.generate(controller.roomDetails.length, (index) {
            return Container(
              padding: const EdgeInsets.symmetric(
                  horizontal: Dimensions.space6, vertical: Dimensions.space8),
              margin: const EdgeInsets.only(bottom: Dimensions.space10),
              decoration: BoxDecoration(
                  borderRadius: index == controller.roomDetails.length - 1
                  ...
                  Align(
                      ...
                      child: Text(
                          DateConverter.formatStringDateTime(
                              controller.roomDetails[index].date?.tr ?? ''.tr,
                              onlyDate: true),
                          style: boldLargeManrope)),
                  const CustomDivider(
                    space: 10,
                  ),
                  Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: List.generate(
                                    controller
                                            .roomDetails[index].rooms?.length ??
                                        0, (roomIndex) {
                                  return Padding(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: List.generate(
                                        controller.roomDetails[index].rooms
                                                ?.length ??
                                            0, (roomIndex) {
                                      return Padding(
                                        padding:
