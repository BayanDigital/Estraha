...
class _BookingDetailsScreenState extends State<BookingDetailsScreen> {
  ...
  void initState() {
    ...
    var bookingDetailsController =
        Get.put(BookingDetailsController(bookingDetailsRepo: Get.find()));
        ...
        body: controller.isLoading
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text(MyStrings.hotelDetails.tr,
                        style: boldOverLargeRajdhani),
                    const CustomDivider(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.only(
                              ...
                              bottomLeft: controller.isRoomDetails
                                  ? const Radius.circular(0.0)
                                  : const Radius.circular(4),
                              bottomRight: controller.isRoomDetails
                                  ? const Radius.circular(0.0)
                                  : const Radius.circular(4),
                            ),
                    ...
                    controller.isRoomDetails
                        ? RoomDetailsWidget(controller: controller)
