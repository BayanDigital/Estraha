        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: WillPopScope(
            ...
            child: Scaffold(
                          ...
                          children: List.generate(
                            ...
                            (index) => Column(
                              children: [
                                ...
                                controller.roomList.length - 1 == index
                                    ? const SizedBox(
                                        height: 20,
                                      )
                                    : const CustomDivider(
              ...
              floatingActionButton: controller.selectedRoomList.isEmpty
                  ...
                  : GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              "${MyStrings.selectedRoom.tr} ${controller.selectedRoomList.length}",
                            ...
                            SvgPicture.asset(
                              ...
                              colorFilter: const ColorFilter.mode(
                                  MyColor.colorWhite, BlendMode.srcIn),
                            )
                          ],
                        ),
                      ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (controller.totalAssignedAdultOnRoom >=
                                  controller.homeController.numberOfAdults &&
                              controller.totalAssignedChildrenOnRoom >=
                                  controller.homeController.numberOfChildren) {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: controller.totalAssignedAdultOnRoom >=
                                          controller
                                              .homeController.numberOfAdults &&
                                      controller.totalAssignedChildrenOnRoom >=
                                          controller
                                              .homeController.numberOfChildren
                                  ? MyColor.primaryColor
                                  : MyColor.primaryColor.withOpacity(.8),
                              borderRadius: BorderRadius.circular(4)),
                          child: Text(MyStrings.next.tr,
                              style: regularMediumLarge.copyWith(
                                  color: controller.totalAssignedAdultOnRoom >=
                                              controller.homeController
                                                  .numberOfAdults &&
                                          controller
                                                  .totalAssignedChildrenOnRoom >=
                                              controller.homeController
                                                  .numberOfChildren
