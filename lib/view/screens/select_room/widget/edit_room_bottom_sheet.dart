    ...
    return GetBuilder<RoomSelectController>(
      builder: (controller) => Column(
        children: [
          ...
          Column(
            children:
                List.generate(controller.selectedRoomList.length, (index) {
                ...
                children: [
                  Row(
                    ...
                    children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                          child: Text(
                                        '${roomList.totalAdult} ${MyStrings.adults.tr}, ${roomList.totalChild} ${MyStrings.children.tr}',
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        TextSpan(
                                          text:
                                              " ${Get.find<ApiClient>().getCurrencyOrUsername(isSymbol: true).tr}",
                                          style: boldLarge.copyWith(
                                              fontFamily: "Tajawal",
                                        ...
                                        TextSpan(
                                          text:
                                              ' /${MyStrings.night.tr.toTitleCase()}',
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          '${MyStrings.cancellationFee.tr} ${Get.find<ApiClient>().getCurrencyOrUsername(isSymbol: true)}${Converter.formatNumber(roomList.cancellationFee ?? '0')}',
                                          style: regularDefault.copyWith(
                                              fontFamily: "Tajawal",
                                              color: Theme.of(context)
                                                  .primaryColor),
                      ...
                      GestureDetector(
                        onTap: () {
                          controller.removeSelectedRoomListItem(
                              roomList, index);
                          controller.deductFromPayableAmount(
                              double.parse(roomList.discountedFare.toString()));
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color:
                                        MyColor.titleTextColor.withOpacity(.2),
                                    width: .5)),
                            child: Text(
                              MyStrings.remove.tr,
                              style: regularDefault.copyWith(
                  ...
                  controller.selectedRoomList.length - 1 == index
                      ? const SizedBox(
