...
class HotelPreviewSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<RoomSelectController>(builder: (controller) {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(controller.roomList[index].name?.tr ?? '',
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              child: Text(
                            controller.getBedInfo(index).tr,
                      ...
                      Stack(
                        children: [
                          Padding(
                            ...
                            child: Text(
                                '${MyStrings.cancellationFee.tr} ${Get.find<ApiClient>().getCurrencyOrUsername(isSymbol: true)}${Converter.formatNumber(roomList.cancellationFee ?? '')}',
                                style: regularDefault.copyWith(
                                    fontFamily: "Tajawal",
                                    color: Theme.of(context).primaryColor)),
                          ),
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.toNamed(RouteHelper.roomDetailsScreen,
                              arguments: index);
                        },
                        child: Row(
                          children: [
                            Text(
                              MyStrings.viewDetails.tr,
                              style: regularDefault.copyWith(
