          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  MyStrings.selectRoom.tr,
                  style: tajawal24White500,
                ),
                const SizedBox(
                  height: 10,
                ),
                Row(
                  ...
                  children: [
                    Text(
                      '${DateConverter.formatDateInDayMonth(controller.checkInDate)} ${MyStrings.to.tr} ${DateConverter.formatDateInDayMonth(controller.checkOutDate)}',
                      style:
                    ...
                    Text(
                      '  ${controller.numberOfRooms} ${MyStrings.room.tr}',
                      style:
                          regularSmall.copyWith(color: MyColor.bodyTextColor),
                    ),
                    const HorizontalDivider(),
                    ...
                    Text(
                      '  ${controller.numberOfGuests} ${MyStrings.guests.tr}',
                      style:
                          regularSmall.copyWith(color: MyColor.bodyTextColor),
                    ),
                  ],
