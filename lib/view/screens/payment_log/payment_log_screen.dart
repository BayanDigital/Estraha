...
class _PaymentLogScreenState extends State<PaymentLogScreen> {
  ...
  void init() {
    ...
    final paymentController =
        Get.put(PaymentLogController(paymentLogRepo: Get.find()));
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      builder: (controller) => Scaffold(
        ...
        body: controller.isLoading
            ...
            : Container(
                ...
                child: controller.paymentLogList.isEmpty
                    ? CustomNoDataScreen(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              '${Converter.formatNumber(paymentLog.amount ?? '')} ${paymentLog.methodCurrency}',
                                          ...
                                          PaymentStatusWidget(
                                              onlyText: true,
                                              fontSize: 12,
                                              status: paymentLog.status == '0'
                                                  ? MyStrings.initiatePayment.tr
                                                  : paymentLog.status == '1'
                                                      ? MyStrings
                                                          .successPayment.tr
                                                      : paymentLog.status == '2'
