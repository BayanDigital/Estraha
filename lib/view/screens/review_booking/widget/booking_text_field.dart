...
class _BookingTextFieldState extends State<BookingTextField> {
  ...
  Widget build(BuildContext context) {
    return widget.phoneNumberTextField == false
        ? TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: regularLarge.copyWith(
                  color: MyColor.bodyTextColor2, fontWeight: FontWeight.w500),
              enabledBorder: OutlineInputBorder(
                  borderSide: const BorderSide(color: MyColor.transparentColor),
              ...
              errorBorder: OutlineInputBorder(
                  borderSide:
                      const BorderSide(width: 0.5, color: MyColor.colorRed),
                  borderRadius: BorderRadius.circular(6)),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            controller.selectedCountryDialCode.tr,
                            style: regularLarge,
                          ),
                          Container(
                  ...
                  child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: const OutlineInputBorder(
                            borderSide:
                                BorderSide(color: MyColor.transparentColor),
