...
class _ReviewBookingScreenState extends State<ReviewBookingScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(
        ReviewBookingController(reviewBookingRepo: Get.find()),
        permanent: true);
    ...
    return GetBuilder<ReviewBookingController>(
      builder: (reviewBookingController) => GetBuilder<RoomSelectController>(
        builder: (controller) => Scaffold(
            ...
            body: reviewBookingController.countryLoading
                ? const CustomLoader()
                : SafeArea(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          Get.find<HotelDetailsScreenController>()
                                  .hotelSetting!
                                  .cancellationPolicy!
                                  .isEmpty
                          ...
                          Get.find<HotelDetailsScreenController>()
                              ...
                              : Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color: MyColor.colorRed, width: 1)),
                                  child: Column(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      CustomReadMoreText(
                                          ...
                                          trimCollapsedText:
                                              MyStrings.seeMore.tr,
                                          trimExpandedText:
                                              MyStrings.seeLess.tr,
                                          moreStyle: regularLarge.copyWith(
                                              color: MyColor.primaryColor,
                                              fontWeight: FontWeight.w600),
                                          lessStyle: regularLarge.copyWith(
                                              color: MyColor.primaryColor,
                                              fontWeight: FontWeight.w600),
                                          style: mediumLarge.copyWith(
                                              color: MyColor.bodyTextColor2)),
                                      const SizedBox(
                                        height: 4,
                                      ),
                                    ],
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(MyStrings.passportOrGovApproveID.tr,
                                      style: regularLarge.copyWith(
                                          color: MyColor.bodyTextColor2)),
                                  const SizedBox(height: 15),
                                  BookingTextField(
                                    controller:
                                        reviewBookingController.nameController,
                                    labelText: MyStrings.enterGuestName.tr,
                                    focusNode:
                                        reviewBookingController.nameFocusNode,
                                    nextFocus: reviewBookingController
                                    ...
                                    child: Row(
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            CountryBottomSheet
                                                .reviewBookingCountryBottomSheet(
                                                    context,
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              focusNode: reviewBookingController
                                                  .phoneNumberFocusNode,
                                              onChanged: (value) {
                                                reviewBookingController
                                                        .phoneNumberController
                                  ...
                                  isNumberBlank
                                      ? Padding(
                                          ...
                                          child: Text(
                                              MyStrings.enterYourPhoneNumber.tr,
            ...
            bottomNavigationBar: reviewBookingController.countryLoading
                ? const SizedBox.shrink()
                : SafeArea(
                    child: Container(
                      padding: const EdgeInsets.all(16),
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Expanded(
                                        child: MarqueeWidget(
                                            child: Text(
                                      "${Converter.formatNumber(controller.totalPayableAmount.toString().tr, precision: 2)} ${Get.find<ApiClient>().getCurrencyOrUsername()}",
                                      style: mediumSemiLarge.copyWith(
                                          color: MyColor.colorWhite),
                                    ))),
                                  ],
                                ),
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        TextSpan(
                                            text:
                                                '+${Get.find<ApiClient>().getCurrencyOrUsername(isSymbol: true)}${Converter.formatNumber(controller.taxAmount.toString())} ',
                                            style: regularDefault.copyWith(
                                                color: MyColor.colorWhite,
                                                fontWeight: FontWeight.w700)),
                                        TextSpan(
                                            text: controller
                                                    .hotelDetailsScreenController
                                                    .hotelSetting
                                                    ?.taxName ??
                                                '',
                                            style: regularSmall.copyWith(
                                ...
                                const SizedBox(height: Dimensions.space8),
                                Text(
                                  '${MyStrings.forText.tr} ${controller.homeController.numberOfNights()} ${MyStrings.night.toTitleCase().tr}',
                                  style: regularSmall.copyWith(
                                      color: MyColor.colorWhite),
                                )
                              ],
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: reviewBookingController.submitLoading
                                  ? const SizedBox(
                                      height: 16,
                                      width: 16,
                                  ...
                                  : Text(MyStrings.requestBooking.tr,
                                      style: regularLarge.copyWith(
                                          color: MyColor.primaryTextColor,
