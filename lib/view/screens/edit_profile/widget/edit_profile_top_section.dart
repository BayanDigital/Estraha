...
class _EditProfileTopSectionState extends State<EditProfileTopSection> {
  ...
  void initState() {
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      statusBarColor: MyColor.colorWhite, // change status bar color
      statusBarIconBrightness:
          Brightness.dark, // icons color (light for dark background)
    ));
    super.initState();
  }
        ...
        builder: (controller) => Container(
              ...
              child: Column(
                ...
                children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Icon(Icons.camera_alt,
                                color: MyColor.colorWhite, size: 12.5),
                          ),
                        ),
                      )
                    ],
                  ...
                  Text(
                    "${controller.firstNameController.text.tr}${controller.lastNameController.text.tr}",
