      ...
      builder: (controller) => PhysicalModel(
        ...
        child: TextFormField(
          style: const TextStyle(
              color: MyColor.primaryColor, fontFamily: "Tajawal", fontSize: 15),
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
                fontFamily: 'Tajawal',
                color: MyColor.primaryColor.withOpacity(.8),
              ...
              child: Padding(
                ...
                child: SvgPicture.asset(
                  ...
                  colorFilter: ColorFilter.mode(
                      MyColor.primaryColor.withOpacity(.8), BlendMode.srcIn),
                ),
              ),
            ),
            ...
            //           MyColor.naturalDark, BlendMode.srcIn),
            //     )),
            labelStyle: tajawal14White400.copyWith(
                color: MyColor.colorBlack, fontWeight: FontWeight.w400),
