...
import 'package:booking_box/view/components/buttons/custom_elevated_button.dart';
    ...
    return GetBuilder<TicketDetailsController>(
        builder: (controller) => Column(
              children: [
                ...
                Text("${MyStrings.supportedFileType.tr} ${MyStrings.ext.tr}",
                    style: regularSmall.copyWith(color: MyColor.getGreyText())),
                                    ...
                                    Stack(
                                      children: [
                                        Container(
                                          ...
                                          child: MyUtils.isImage(controller
