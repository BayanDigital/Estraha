                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(controller
                                    .onboardImageList[controller.currentIndex]),
                                fit: BoxFit.none,
                              ),
                            ),
                          );
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: Dimensions.space50, horizontal: 20),
                  child: Row(
                              ...
                              onTap: () {
                                ...
                                Get.find<ApiClient>().sharedPreferences.setBool(
                                    SharedPreferenceHelper
                                        .firstTimeAppOpeningStatus,
                                    false);
                              },
                              child: Container(
                                margin: const EdgeInsets.only(
                                    right: Dimensions.space10 - 1),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 40, vertical: 13),
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(7),
                                    border: Border.all(
                                        width: 1, color: MyColor.colorWhite)),
                                child: Text(
                                  MyStrings.signUp.tr,
                          ...
                          : Row(
                              children: [
                                TextButton(
                                    ...
                                    child: controller.onboardTitleList.length -
                                                1 ==
                                            controller.currentIndex
                                        ? const SizedBox.shrink()
                                        : Text(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          controller
                              .onboardTitleList[controller.currentIndex].tr,
                          textAlign: TextAlign.center,
                          style: boldOverLarge.copyWith(
                              fontSize: 30, color: MyColor.primaryColor)),
                      SizedBox(height: size.height * .015),
                      Text(
                          textAlign: TextAlign.center,
                          controller
                              .onboardSubTitleList[controller.currentIndex].tr
                              .toCapitalized(),
                          style: regularDefault.copyWith(
                              fontSize: 20, color: MyColor.primaryTextColor)),
                      SizedBox(
