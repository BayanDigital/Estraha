...
//                           ),
//                           // BottomSheetCard(
//                           //   child: Text('+${controller.filteredCountries[index].dialCode}  ${controller.filteredCountries[index].country?.tr ?? ''}', style: regularDefault.copyWith(color: MyColor.getTextColor())),
//                           // ),
//                         );
//                       }),
//                 )
...
//   }
//
//   static void bottomSheetProfile(BuildContext context, ProfileCompleteController controller) {
//     CustomBottomSheet(
//       child: StatefulBuilder(
//         builder: (BuildContext context, setState) {
//           if (controller.filteredCountries.isEmpty) {
