...
import 'package:booking_box/view/components/circle_button_with_icon.dart';
...
import 'package:booking_box/view/components/image/circle_shape_image.dart';
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style:
                              regularSmall.copyWith(color: MyColor.colorWhite),
                        )
                      ],
                    ),
                  ),
            ...
            Row(
              children: [
                const CircleShapeImage(
                    imageColor: MyColor.primaryColor, image: MyImages.name),
