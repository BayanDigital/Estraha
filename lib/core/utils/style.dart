...
//------------------------------------------------------------------------
const TextStyle tajawal20White700 = TextStyle(
    fontFamily: 'Tajawal',
    color: MyColor.colorWhite,
    fontWeight: FontWeight.w700,
    fontSize: 20);

const TextStyle tajawal15PrimaryColor500 = TextStyle(
    fontFamily: 'Tajawal',
...
const TextStyle tajawal24White500 = TextStyle(
    fontFamily: 'Tajawal',
    color: MyColor.colorWhite,
    fontWeight: FontWeight.w500,
    fontSize: 20);

const TextStyle tajawal14White400 = TextStyle(
    fontFamily: 'Tajawal',
    color: MyColor.colorWhite,
...
const TextStyle mediumSemiLarge = TextStyle(
    fontFamily: 'Inter',
    color: MyColor.primaryTextColor,
...
const TextStyle semiBoldOverLargeManrope = TextStyle(
    fontFamily: 'Manrope',
    color: MyColor.primaryTextColor,
    fontWeight: FontWeight.w600,
    fontSize: Dimensions.fontOverLarge);

const TextStyle regularLargeTajawal = TextStyle(
    fontFamily: 'Tajawal',
    color: MyColor.primaryTextColor,
    fontWeight: FontWeight.w700,
    fontSize: Dimensions.fontLarge);

const TextStyle boldLargeManrope = TextStyle(
    fontFamily: 'Manrope',
    color: MyColor.primaryTextColor,
...
TextStyle boldLargeRajdhani = TextStyle(
    fontFamily: 'Rajdhani',
    color: MyColor.getTextColor(),
    fontWeight: FontWeight.bold,
    fontSize: Dimensions.fontMediumLarge + 1);

TextStyle boldOverLargeRajdhani = TextStyle(
    fontFamily: 'Rajdhani',
